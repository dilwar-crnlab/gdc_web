...
// Get active faculty for Arts department
function getArtsFaculty() {
    global $db;
    
    try {
        $stmt = $db->prepare("SELECT * FROM faculty WHERE department = 'arts' AND status = 'active' ORDER BY display_order ASC, name ASC");
        $stmt->execute();
        ...
        if (DEBUG_MODE) {
            error_log('Error fetching arts faculty: ' . $e->getMessage());
        }
        return [];
    }
}

$faculty_members = getArtsFaculty();
?>
...
<head>
    ...
    <title>Arts Faculty - DCB Girls College Jorhat</title>
    <meta name="description" content="Meet our dedicated Arts faculty at D.C.B. Girls College Jorhat">
            ...
            <div class="d-flex">
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a class="dropdown-item" href="faculty_computer.php">Computer Science Faculty</a></li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item active">Arts Stream</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <div class="faculty-header text-center">
        <div class="container">
            <h1 class="display-4 font-heading fw-bold mb-3">
                <i class="bi bi-book me-3"></i>Arts Faculty
            </h1>
            <p class="lead mb-0">Dedicated educators shaping minds in humanities and liberal arts</p>
        </div>
    </div>
                            ...
                            <div class="card-body text-center p-4">
                                ...
                                <?php if (!empty($faculty['qualification'])): ?>
                                    <div class="faculty-info mb-3">
                                        ...
                                        <p class="mb-0 fw-bold text-primary"><?php echo htmlspecialchars($faculty['qualification']); ?></p>
                                    </div>
                                <?php endif; ?>
                                ...
                                <?php if (!empty($faculty['bio']) || !empty($faculty['research_interests']) || !empty($faculty['publications'])): ?>
                                    <button class="btn btn-outline-primary btn-sm mt-3" onclick="showFacultyDetails(<?php echo $faculty['id']; ?>)">
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-md-6 text-md-end">
                    ...
                    <a href="faculty_science.php" class="text-light text-decoration-none me-3">Science</a>
                    <a href="faculty_computer.php" class="text-light text-decoration-none">Computer Science</a>
                </div>
            </div>
        </div>
    </footer>
